...
class Node 
{
  ...
  public:
    ...
    virtual char *GetName() { return NULL; }  //PV - purpose of this: sometimes need to know what the parent's name is (need to know name of function declaration in order to add to hashmap)
    Location *GetCgLoc() { return cgLoc; }
    void SetCgLoc(Location *cgLoc) { this->cgLoc = cgLoc; }
